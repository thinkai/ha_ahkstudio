menu_editor(x:=0){
	...
	if (ssn(top,"@menu").text="")
		main:=top.ParentNode
	new:=menus.under({under:main,node:"menu",att:{name:newname,last:1,clean:clean(newname)}}),main.insertbefore(new,top),under.insertbefore(above,move),menu_editor(1)
	return
	moveup:
	Gui,2:Default
